...
public class ActivatibleImpl extends InitializableImpl implements Activatible {
	...
	public ActivatibleImpl() {
		...
		decayStrategy = strategyFactory.getStrategy("defaultDecayStrategy", DecayStrategy.class);
		exciteStrategy = strategyFactory.getStrategy("defaultExciteStrategy", ExciteStrategy.class);
	}
